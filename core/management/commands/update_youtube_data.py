...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        # Replace this with your logic for retrieving access tokens
    ...
    def update_demographics(self, youtube_analytics, channel_instance, channel_info):
        ...
        # Update geographic demographics (if needed)
        # geographic_demographics_request = youtube_analytics.reports().query(
        #     ids=f'channel=={channel_instance.channel_id}',
        #     startDate=start_date,
        #     endDate=end_date,
        #     metrics='viewerPercentage',
        ...
        #     sort='country'
        # )
        # geographic_demographics_response = geographic_demographics_request.execute()

        # for row in geographic_demographics_response.get('rows', []):
        #     YouTubeGeographicDemographics.objects.update_or_create(
        #         channel_information=channel_instance,
        #         date=datetime.now(),
        #         defaults={
        #             'country': row[0],
